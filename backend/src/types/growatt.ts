...
type ParseRetFunction = (val: any, resolve: (val: any) => void) => void;
...
interface ComInverterFunction {
    name: string;
    type?: string;
    paramId: string;
    parseRet: ParseRetFunction;
...
interface DeviceTypeConfig {
    ...
    invIdParam?: string;
    atIndex?: number;
    comInverter?: Record<string, ComInverterFunction>;
}

type GrowattTypeConfig = {
    [MAX]: DeviceTypeConfig;
    [MIX]: DeviceTypeConfig;
    [INV]: DeviceTypeConfig;
    [TLX]: DeviceTypeConfig;
    [TLXH]: DeviceTypeConfig;
    [STORAGE]: DeviceTypeConfig;
    [SPA]: DeviceTypeConfig;
    [HPS]: DeviceTypeConfig;
    [SINGLEBACKFLOW]: DeviceTypeConfig;
    [MULTIPLEBACKFLOW]: DeviceTypeConfig;
    [NOAH]: DeviceTypeConfig;
};

const GROWATTTYPE: GrowattTypeConfig = {
    [MAX]: {
        snParam: "maxSn",
        ...
        comInverter: {
            ...
            pvActivePRate: {
                ...
                param: {
                    ...
                    param2: { name: "Store", type: "BOOL", def: false },
                },
            },
        },
    },
        ...
        comInverter: {
            ...
            gridFirst: {
                ...
                param: {
                    ...
                    param13: {
                        name: "Time slot 3 start HH",
                        type: "INUM_0_24",
                    },
                    param14: {
                        name: "Time slot 3 start MI",
                        type: "INUM_0_60",
                    },
